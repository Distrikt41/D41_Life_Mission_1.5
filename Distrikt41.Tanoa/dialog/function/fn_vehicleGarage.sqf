...
call life_fnc_D41_GetGangBaseName;
[[getPlayerUID player,playerSide,_type,player,life_D41_Karma,life_fnc_D41_GetGangBaseName],"TON_fnc_getVehicles",false,false] call life_fnc_MP;
