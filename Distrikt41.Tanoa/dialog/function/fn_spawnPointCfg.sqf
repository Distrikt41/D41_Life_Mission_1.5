...
switch (_side) do
{
	case west:
	{
		...
		{
			_return = [
			["cop_spawn_1","Roenne HQ","\a3\ui_f\data\map\groupicons\selector_selectedmission_ca.paa"],
			["cop_spawn_6","Roenne Innenstadt","\a3\ui_f\data\map\GroupIcons\badge_rotate_0_gs.paa"],
			["cop_spawn_2","Aakirkeby","\a3\ui_f\data\map\GroupIcons\badge_rotate_0_gs.paa"],
		...
		if(license_cop_gangfirma && playerSide == west) then {
		_return = _return +[
								["cop_spawn_5","Security HQ","\a3\ui_f\data\map\GroupIcons\selector_selectedmission_ca.paa"],
								["cop_spawn_10","Security Nexoe","\a3\ui_f\data\map\GroupIcons\selector_selectedmission_ca.paa"],
								["cop_spawn_6","Roenne Innenstadt","\a3\ui_f\data\map\GroupIcons\selector_selectedmission_ca.paa"]
							];
		};
	...
	case civilian:
	{
		...
		_return = _return +[
								["civ_spawn_dmw01","DMW Basis","\a3\ui_f\data\map\MapControl\fortress_ca.paa"],
								["civ_spawn_dmw02","Waffendealer","\a3\ui_f\data\map\MapControl\rock_ca.paa"]
							];
		};
		
		if(license_civ_navyseal && playerSide == civilian) then {
		_return = _return +[
								["civ_spawn_seal01","Basislager 1","\a3\ui_f\data\map\MapControl\fortress_ca.paa"],
								["civ_spawn_seal02","Basislager 2","\a3\ui_f\data\map\MapControl\rock_ca.paa"]
							];
		};
		
		if(license_civ_mayor && playerSide == civilian) then {
		_return = _return +[
								["mayor_1","Bürgermeister Villa","\a3\ui_f\data\map\MapControl\tourism_ca.paa"]
							];
		};
		
		if(license_civ_base01 && playerSide == civilian) then {
		_return = _return +[
								["Base_1","Gangbase 01 Bandit","\a3\ui_f\data\map\MapControl\tourism_ca.paa"]
							];
		};
		
		if(license_civ_base02 && playerSide == civilian) then {
		_return = _return +[
								["Base_2","Gangbase 02 Bandit","\a3\ui_f\data\map\MapControl\tourism_ca.paa"]
							];
		};
		
		if(license_civ_base03 && playerSide == civilian) then {
		_return = _return +[
								["Base_3","Gangbase 03 Neutral","\a3\ui_f\data\map\MapControl\tourism_ca.paa"]
							];
		};
		
		if(license_civ_base04 && playerSide == civilian) then {
		_return = _return +[
								["Base_4","Gangbase 04 Neutral","\a3\ui_f\data\map\MapControl\tourism_ca.paa"]
							];
		};
		
		if(license_civ_base05 && playerSide == civilian) then {
		_return = _return +[
								["Base_5","Gangbase 05 Hero","\a3\ui_f\data\map\MapControl\tourism_ca.paa"]
							];
		};
		
		if(license_civ_base06 && playerSide == civilian) then {
		_return = _return +[
								["Base_6","Gangbase 06 Hero","\a3\ui_f\data\map\MapControl\tourism_ca.paa"]
							];
		};
		
		if(license_civ_base07 && playerSide == civilian) then {
		_return = _return +[
								["Base_7","Gangbase 07 Neutral","\a3\ui_f\data\map\MapControl\tourism_ca.paa"]
							];
		};
	...
	case independent:
	{
		...
		_return = _return + [
								["civ_spawn_31","ADAC Service","\a3\ui_f\data\map\MapControl\hospital_ca.paa"],
								["civ_spawn_32","ADAC HQ Service","\a3\ui_f\data\map\MapControl\hospital_ca.paa"],
								["civ_spawn_33","ADAC Service","\a3\ui_f\data\map\MapControl\hospital_ca.paa"],
								["civ_spawn_34","ADAC Service","\a3\ui_f\data\map\MapControl\hospital_ca.paa"]
							];
		};
		
		if(((call life_mediclevel) >= 1) && playerSide == independent && !license_med_adac) then {
		_return = _return +[
								["medic_spawn_1","URD Hauptquartier","\a3\ui_f\data\map\MapControl\hospital_ca.paa"],
