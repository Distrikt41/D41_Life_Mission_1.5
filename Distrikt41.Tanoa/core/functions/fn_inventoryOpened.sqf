...
//};
if((_container isEqualTo D41_MissionBox) && ((!(hideoutOwner1 isEqualTo hideoutOwner2) && !(isNull hideoutOwner1)) OR (!(hideoutOwner1 isEqualTo hideoutOwner3) && !(isNull hideoutOwner1)) OR (!(hideoutOwner2 isEqualTo hideoutOwner3) && !(isNull hideoutOwner2))) && ({side _x == civilian} count playableUnits < 10)) exitWith
{
	hint localize "STR_MISC_VehInventory";
	ctrlShow [640,false];
	ctrlEnable [640, false];
