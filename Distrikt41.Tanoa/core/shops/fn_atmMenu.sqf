...
lbClear _units;
_text ctrlSetStructuredText parseText format["<img size='1.7' image='icons\bank.paa'/> €%1<br/><img size='1.6' image='icons\money.paa'/> €%2",[D41_atmGeld] call life_fnc_numberText,[D41_Geld] call life_fnc_numberText];
...
_playerID = steamid;
if(_ownerID != _playerID or isNil {(grpPlayer getVariable "gang_bank")}) then {
