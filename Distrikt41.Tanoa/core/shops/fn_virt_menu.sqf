...
if(_shop == "navyseal" && !license_civ_navyseal) exitWith {hint format [localize "STR_Shop_NotaGang"];};
if(_shop == "navyseal_waffen" && !license_civ_navyseal) exitWith {hint format [localize "STR_Shop_NotaGang"];};
if(_shop == "mayor" && !license_civ_mayor) exitWith {hint format [localize "STR_Shop_NotMayor"];};
if(_shop == "mayor_waffen" && !license_civ_mayor) exitWith {hint format [localize "STR_Shop_NotMayor"];};
...
if(_shop == "base_07" && !license_civ_base07) exitWith {hint format [localize "STR_Shop_NotaGang"];};
if(_shop == "base_07_waffen" && !license_civ_base07) exitWith {hint format [localize "STR_Shop_NotaGang"];};
