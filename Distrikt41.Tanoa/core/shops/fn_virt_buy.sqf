...
_BlockedItems = ["D41_Heroin", "D41_Oel", "D41_Cannabis", "D41_Kokain", "D41_Diamanten", "D41_Aluminium", "D41_Eisen", "D41_Kupfer", "D41_Salz", "D41_Kohle", "D41_Glas", "D41_Apfelsaft", "D41_Ton", "D41_Zement", "D41_Stahl", "D41_Fahrzeugteile", "D41_Kerosin", "D41_Kalkstein", "D41_Krabben"];
_ZiviSpielerOnline = {side _x == civilian} count playableUnits;
if ((_ZiviSpielerOnline < 1) && (_type in _BlockedItems)) exitWith{closedialog 0; D41_IsBuying = false; hint format ["Nicht genug Zivilisten Online. %1/25", _ZiviSpielerOnline];};
