...
switch (_shop) do
{
	...
	//FIRMA SECURITY
	case "firmaitems": {
					if((_shop == "firmaitems") && (playerSide == west) && license_cop_gangfirma && ((call life_coplevel) < 3)) then {_return =
		["Firma Ausrüstung",
					["D41_Kaffee","D41_EnergyDrink","D41_Donuts","D41_Dietrich",
					"D41_BenzinKanister","ItemGPS","Rangefinder","D41_ToolKit","D41_MediKit","D41_Handy","D41_Handy_cop","SmokeShellBlue","Chemlight_blue","pmc_earpiece"]
					]};

					if((_shop == "firmaitems") && (playerSide == west) && license_cop_gangfirma && ((call life_coplevel) >= 3)) then {_return =
		["Firma Ausrüstung",
					["D41_Kaffee","D41_EnergyDrink","D41_Donuts",
					"D41_Mauer","D41_Strahler","D41_Schranke","D41_Dietrich",
					"D41_BenzinKanister","ItemGPS","Rangefinder","D41_ToolKit","D41_MediKit","D41_Handy","D41_Handy_cop","SmokeShellBlue","Chemlight_blue","pmc_earpiece"]
					]};
				};
	...
	case "firmawaffen":	{
		...
		["Security Trainee",
					["D41_Tazer_X3_Black","D41_6Rnd_Tazer",
					"D41_M590A1","D41_5Rnd_12G_Gummi",
					"RH_sbr9","RH_32Rnd_9mm_M822",
					"optic_ACO_grn","FHQ_optic_AC11704","FHQ_optic_AC12136","optic_MRCO","optic_Arco","optic_Hamr",
					"RH_compM2l","RH_SFM952V","acc_pointer_IR","FHQ_acc_LLM01L","RH_peq15","RH_peq15_top","RH_peq2","RH_peq2_top","RH_SFM952V","RH_SFM952V_tan"]
					]};

					if((_shop == "firmawaffen") && ((call life_coplevel) == 2) && license_cop_gangfirma) then {_return =
		["Security Objektschützer",
					["D41_Tazer_X3_Black","D41_6Rnd_Tazer",
					"RH_usp","RH_12Rnd_45cal_usp","RH_fhusp","RH_X2","RH_M6X","RH_X300",
					"D41_M590A1","D41_5Rnd_12G_Gummi","D41_5Rnd_12G_74Slug",
					"RH_sbr9","RH_32Rnd_9mm_M822",
					"hlc_rifle_RU5562","rhs_mag_30Rnd_556x45_Mk318_Stanag","RH_M4A1_ris","RH_M4A1_ris_M203s","30Rnd_556x45_Stanag","UGL_FlareWhite_F","1Rnd_SmokeBlue_Grenade_shell",
					"bipod_02_F_blk",
					"RH_compM2l","optic_ACO_grn","FHQ_optic_AC11704","FHQ_optic_AC12136","optic_MRCO","optic_Arco","optic_Hamr","RH_eotech553mag","optic_SOS","optic_DMS","optic_LRPS",
					"acc_pointer_IR","FHQ_acc_LLM01L","RH_peq15","RH_peq15_top","RH_peq2","RH_peq2_top","RH_SFM952V","RH_SFM952V_tan"]
					]};

					if((_shop == "firmawaffen") && ((call life_coplevel) == 3) && license_cop_gangfirma) then {_return =
		["Security Begleitschützer",
					["D41_Tazer_X3_Black","D41_6Rnd_Tazer",
					"RH_usp","RH_12Rnd_45cal_usp","RH_fhusp","RH_X2","RH_M6X","RH_X300",
					"D41_M590A1","D41_5Rnd_12G_Gummi","D41_5Rnd_12G_74Slug",
					"RH_sbr9","RH_32Rnd_9mm_M822",
					...
					"hlc_m249_SQuantoon","hlc_200rnd_556x45_M_SAW",
					"bipod_02_F_blk",
					"RH_compM2l","optic_ACO_grn","FHQ_optic_AC11704","FHQ_optic_AC12136","optic_MRCO","optic_Arco","optic_Hamr","RH_eotech553mag","optic_SOS","optic_DMS","optic_LRPS",
					"acc_pointer_IR","FHQ_acc_LLM01L","RH_peq15","RH_peq15_top","RH_peq2","RH_peq2_top","RH_SFM952V","RH_SFM952V_tan"]
					]};
		...
		["Security Personenschützer",
					...
					"hlc_smg_mp510","hlc_30Rnd_10mm_B_MP5",
					"hlc_rifle_RU5562","rhs_mag_30Rnd_556x45_Mk318_Stanag","RH_M4A1_ris","RH_M4A1_ris_M203s","30Rnd_556x45_Stanag","UGL_FlareWhite_F","1Rnd_SmokeBlue_Grenade_shell",
					"hlc_rifle_G36CV","hlc_rifle_g36KTac","hlc_30rnd_556x45_EPR_G36",
					...
					if((_shop == "firmawaffen") && ((call life_coplevel) == 5) && license_cop_gangfirma) then {_return =
		["Security Führung",
					["D41_Tazer_X3_Black","D41_6Rnd_Tazer",
					"RH_m9","RH_m9c","RH_15Rnd_9x19_M9",
					"RH_usp","RH_12Rnd_45cal_usp","RH_fhusp","RH_X2","RH_M6X","RH_X300",
	...
	case "rebelsouth": {
		...
		["Rebell Heavy",
					...
					"rhs_weap_ak103_1","rhs_30Rnd_762x39mm",
					"CUP_lmg_m249_SQuantoon","CUP_100Rnd_TE4_Red_Tracer_556x45_M249",
					"rhs_weap_rpg7","rhs_rpg7_PG7VL_mag","rhs_rpg7_OG7V_mag",
					"launch_RPG32_F","RPG32_F",
					"bipod_02_F_hex","bipod_01_F_mtp","bipod_01_F_snd","bipod_02_F_tan",
					"hlc_optic_kobra","optic_ACO_grn","optic_Aco","optic_MRCO","optic_Arco","optic_Hamr","acc_flashlight","acc_pointer_IR","RH_peq2","FHQ_optic_AC11704",
