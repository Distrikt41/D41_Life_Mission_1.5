...
//Shop Title Name
ctrlSetText[3103,"Anzüge und Verkleidungen"];
...
switch (_filter) do
{
	...
	case 0:
	{
		[
			...
			["U_PMC_WhtPolo_BluPants","Weißes Poloshirt",2400],
			["U_NikosBody","Playboy",2400],
			["U_NikosAgedBody",localize "STR_D41_Shirt_Tie",4500],
			["TRYK_SUITS_BR_F","Anzug, grau",6000],
			["TRYK_SUITS_BLK_F","Anzug, schwarz",6000],
			["MNP_CombatUniform_CMAR","Nato Uniform",7000]
		];
	};
	...
	case 1:
	{
		[
			...
			["CUP_H_NAPA_Fedora","Indiana Jones",3000],
			["MNP_Helmet_STPilot","Imperialer Helm",3000],
			["MNP_MilCap_CM","Nato Mütze",500]
		];
	};
