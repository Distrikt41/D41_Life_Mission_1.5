...
[] spawn
{
	...
	while{true}do
	{
		...
		_WhiteListedChannels = ["Distrikt41_Ingame", ":: Support Channel - HIER WARTEN", ":: Support Channel! Wird abgefertigt ::", "D41_Ingame", "Distrikt41_Ingame_DEV"];
		
		if(!_IstAdmin && 	_ServerName != ":: Willkommen im Offiziellen Distrikt 41 TS3 ::"	)then{_DarfNixSehen = true;};
