...
private["_type","_Lizenz","_gang","_gangID","_gangBank","_WillBase","_Item","_Amount"];
	...
	if((_Lizenz in ["license_civ_base03","license_civ_base04","license_civ_base07"]) && (_GangKarma < -6000 OR _GangKarma > 6000))exitWith{hint format [localize "STR_D41_NichtGenugKarma", "-6000/+6000"]; systemchat format [localize "STR_D41_NichtGenugKarma", -6000];};
