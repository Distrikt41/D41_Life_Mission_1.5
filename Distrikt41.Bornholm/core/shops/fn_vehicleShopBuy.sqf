...
if(_blocked)exitWith {hint localize "STR_Shop_Veh_Block"};
...
if((life_veh_shop select 0) == "med_air_hs") then
	{
		_vehicle = createVehicle [_className,[0,0,999],[], 0, "CAN_COLLIDE"];
	...
	{
		_vehicle = createVehicle [_className, (getMarkerPos _spawnPoint), [], 0, "CAN_COLLIDE"];
		waitUntil {!isNil "_vehicle"}; //Wait?
...
//[[player, _vehicle, "1"],"D41_fnc_setOwner",false,false] call life_fnc_MP;
