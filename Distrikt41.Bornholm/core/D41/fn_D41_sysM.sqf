//::::::::::::  ::::::::::::\\
//	Filename: D41\scripts\Markt\fn_D41_sysM.sqf
...
diag_log [":::::::::::::::: Marktsystem (CLIENT) geladen ::::::::::::::::"];
...
while{true}do
{
	...
	D41_KPreisDosenfisch = D41_KPreisliste select 25;
	D41_VPreisDosenfisch = D41_VPreisliste select 25;
	
	D41_KPreisAlu = D41_KPreisliste select 26;
	D41_VPreisAlu = D41_VPreisliste select 26;
