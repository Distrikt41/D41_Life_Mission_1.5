...
life_fakeid = 0; 			//Hat eine Fake ID? 1 = Ja // 0 = nope
...
D41_ProdInUse = false;//Produziert gerade Waffen?
...
// NameTags, fuehende leeres element weil einfacher bzgl index-start-0 != rank
D41_Ranks_Cop   = ["","Recruit Officer","Officer","Patrol Officer","Master Patrol Officer","Sergeant","Lieutenant","Captain","Inspector","Detective","Chief Assistent","Chief of the Police"];
D41_Ranks_URD = ["","URD Helfer","URD Truppführer","URD Gruppenführer","URD Zugführer","URD Präsident"];   // Raenge waeren nnicht schlecht
D41_Ranks_Sec = ["","Trainee","Objektschützer","Begleitschützer","Personenschützer","Security Leitung"];

// Ammo Conf
D41_TazerAmmo = ["D41_B_Tazer"];    // D41_B_22LR_SD beim update obsolet
D41_RubberBulletAmmo = ["D41_B_12G_Gummi"];    // D41_45ACPGummigeschiss beim update obsolet

// Medical System (MedSys)
D41_MedSys_HitZones = ["HitHead","HitHands","HitBody","HitLegs"];

//:::::::::::: Distrikt41 Items, welche nicht gespeichert werden dürfen / Tanklaster Array ::::::::::::\\

D41_DontSaveThat = ["D41_Blutkonserven","D41_Pizzas","D41_Teddybaer","D41_Gummibaum","D41_HeleneFischerCD","D41_Bankbauplan","D41_Faultierhoden",
					"D41_GoldBarren","D41_Meth1","D41_Meth2","D41_Meth3","D41_Meth4","D41_Meth"];
D41_TanklasterItems = ["D41_Oel","D41_OelRoh","D41_Kerosin","D41_Salz","D41_SalzRoh","D41_Meth1","D41_Meth2"];
D41_TanklasterListe = ["D41_C_Van_01_fuel_F","D41_I_G_Van_01_fuel_F","D41_Civ_Truck_02_fuel2_weiss","D41_Civ_Truck_02_fuel2_blau","D41_Civ_Truck_02_fuel2_orange","D41_Civ_Truck_02_fuel2_Fass","D41_Ural_Fuel_MSV_01","D41_Ural_Fuel_Rot_01","D41_O_Truck_03_fuel_F","D41_B_Truck_01_fuel_F","D41_B_Truck_01_fuel_grau","D41_Civ_Truck_02_fuel2_IHV","D41_B_Truck_01_fuel_hb","D41_B_Truck_01_fuel_s","D41_Heli_Transport_04_fuel_Blaugrau","D41_Heli_Transport_04_fuel_grey","D41_C_Van_01_fuel_white","D41_C_Van_01_fuel_red","D41_C_Van_01_fuel_black","D41_B_Truck_01_fuel_bg"];
...
D41_goggles_Array = ["rhs_scarf","G_Balaclava_blk","G_Balaclava_combat","G_Balaclava_lowprofile","G_Bandanna_blk","G_Balaclava_oli","G_Bandanna_aviator","G_Bandanna_blk","G_Bandanna_khk","G_Bandanna_oli","G_Bandanna_shades","G_Bandanna_sport","G_Bandanna_tan","G_Bandanna_shades","G_Bandanna_beast","TRYK_kio_balaclava_ear"];
...
D41_headgear_Array = ["H_Shemag_olive","H_Shemag_khk","H_Shemag_tan","H_Shemag_olive_hs","H_ShemagOpen_khk","LOP_H_Shemag_IT","H_ShemagOpen_tan","rhs_6b27m_ess_bala","CUP_H_TK_Lungee","H_PilotHelmetHeli_B","H_CrewHelmetHeli_B","CUP_H_TKI_Lungee_01","CUP_H_TKI_Lungee_02","CUP_H_TKI_Lungee_03","CUP_H_TKI_Lungee_04","CUP_H_TKI_Lungee_05","CUP_H_TKI_Lungee_06"];
D41_hmd_Array = ["NVGoggles_mas_mask2_t","NVGoggles_mas_mask3","NVGoggles_mas_mask","NVGoggles_mas_mask_b","NVGoggles_mas_mask_t"];

//:::::::::::: Distrikt41 Falsche Namen ::::::::::::\\
D41_Fake_ID_Array = ["Hans Peter", "Riddley Jones", "John Doe", "Klaus Schmitt", "Ralf Schmitz", "Patrick Star", "Daniel Dollinger", "Tim Stuhlsatz", "Ugly Peterson", "Elrond McBong", "Ben Stifler", "Arnold Schwarzwaldbecher", "Chuck Norris", "Stan Lee", "Olaf Gerold", "John Richmond", "Richard Nelz", "Richard Batsbak", "Gerrie van Boven", "Rikkert Biemans", "Barrie Butser", "Robbie Schuurmans","John Wayne"];
...
life_fnc_D41_TeilHeilung =
{
	...
	if(_DmgKopf < 0) then {_DmgKopf = 0};
	if(_DmgHand < 0) then {_DmgHand = 0};
	if(_DmgTorso < 0) then {_DmgTorso = 0};
	if(_DmgBein < 0) then {_DmgBein = 0};
...
life_fnc_D41_GetGangBaseName =
{
	...
	if(license_civ_base07)exitWith{D41_BaseNameCheck = "license_civ_base07";};
};
...
//:::::::::::: Distrikt41 VehicleProd ::::::::::::\\

life_D41_vehicle_shop_array =
[
	["D41_Fahrzeugschein_Camaro","Camaro",10],		//312.500€
	["D41_Fahrzeugschein_SuperBee","SuperBee",12], //375.000€
	["D41_Fahrzeugschein_Fury_Police","Fury Police",15], //468.750€
	["D41_Fahrzeugschein_Cadillac_Esc","Cadillac Esc.",7], //218.750€
	["D41_Fahrzeugschein_Viper","Doge Viper",12], //375.000€
	["D41_Fahrzeugschein_Vendura","Vendura",4], //125.000€
	["D41_Fahrzeugschein_MiniCooper","MiniCooper",5], //156.250€
	["D41_Fahrzeugschein_Maserati","Maserati",14], //437.500€
	["D41_Fahrzeugschein_Subaru","Subaru",6], //187.500€
	["D41_Fahrzeugschein_LKW","Lkw",16] //500.000€

];
__CONST__(life_D41_vehicle_shop_array,life_D41_vehicle_shop_array);
