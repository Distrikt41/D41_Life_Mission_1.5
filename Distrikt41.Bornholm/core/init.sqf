...
diag_log "------------------------------------------------------------------------------------------------------";
waitUntil { !(isNull player) }; //Wait till the player is ready
...
//[true] call life_fnc_D41_NameTags;  // New Nametags
...
fed_bank_building = nearestObject [[1516.3312,14348.151,-0.293976],"Land_Offices_01_V1_F"]; //Federal Bank Gebäude?
