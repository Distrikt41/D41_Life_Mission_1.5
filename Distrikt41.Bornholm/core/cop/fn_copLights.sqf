...
if((typeOf _vehicle) in _OffroadPol)then		{_lightWhite = [1,1,1];			_lightBlue = [0, 0, 20];	_lightleft setLightAmbient [0,0,1]; _lightright setLightAmbient [0,0,1];};
if((typeOf _vehicle) in _OffroadMedic)then		{_lightWhite = [1,1,1]; 		_lightBlue = [0, 0, 20];	_lightleft setLightAmbient [0,0,1]; _lightright setLightAmbient [0,0,1];};
...
//Sani: "D41_Offroad_Medic2","D41_Offroad_Medic","D41_S1203_Civ_02"
...
if((typeOf _vehicle) in ["D41_BMW_X6M_Pol2"])	then{_lightWhite = [1,1,1];	_lightBlue = [0, 0, 20]; _lightleft setLightAmbient [0,0,1]; _lightright setLightAmbient [0,0,1];_lightleft lightAttachObject  [_vehicle, [-0.4, 2.3, -0.55]];	_lightright lightAttachObject  [_vehicle, [0.4, 2.3, -0.55]];};
if((typeOf _vehicle) in ["D41_tigr_swat"])		then{_lightWhite = [1,1,1];	_lightBlue = [0, 0, 20]; _lightleft setLightAmbient [0,0,1]; _lightright setLightAmbient [0,0,1];_lightleft lightAttachObject  [_vehicle, [-0.37, -1.9, 0.7]];	_lightright lightAttachObject  [_vehicle, [0.37, -1.9, 0.7]];};
if((typeOf _vehicle) in ["D41_swat_hunter"])	then{_lightWhite = [1,1,1];	_lightBlue = [0, 0, 20]; _lightleft setLightAmbient [0,0,1]; _lightright setLightAmbient [0,0,1];_lightleft lightAttachObject  [_vehicle, [-0.37, -1.9, 0.7]];	_lightright lightAttachObject  [_vehicle, [0.37, -1.9, 0.7]];};
