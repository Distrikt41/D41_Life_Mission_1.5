...
while{true}do
{
	...
	_D41_StockAlu =				_queryResult select 26;
	
	
	
	
	//------------------------------ Stock berechnen
	_D41_StockApfel = _D41_StockApfel - (_playercount * 7);							if(_D41_StockApfel < 0)then {_D41_StockApfel = 0;};		
	_D41_StockPfirsich = _D41_StockPfirsich - (_playercount * 6);					if(_D41_StockPfirsich < 0)then {_D41_StockPfirsich = 0;};
	_D41_StockApfelschnaps = _D41_StockApfelschnaps - (_playercount * 4);			if(_D41_StockApfelschnaps < 0)then {_D41_StockApfelschnaps = 0;};
	...
	_D41_Stockoilp = _D41_Stockoilp - (round (_playercount * 0.2));					if(_D41_Stockoilp < 0)then {_D41_Stockoilp = 0;};
	...
	_D41_Stockcocainep = _D41_Stockcocainep - (round (_playercount * 0.5));			if(_D41_Stockcocainep < 0)then {_D41_Stockcocainep = 0;};
	_D41_Stockdiamondc = _D41_Stockdiamondc - (round (_playercount * 0.15));		if(_D41_Stockdiamondc < 0)then {_D41_Stockdiamondc = 0;};
	...
	_D41_StockStahl = _D41_StockStahl - (round (_playercount * 0.3));				if(_D41_StockStahl < 0)then {_D41_StockStahl = 0;};
	...
	_D41_StockKerosin = _D41_StockKerosin - (_playercount * 0.1);					if(_D41_StockKerosin < 0)then {_D41_StockKerosin = 0;};
	_D41_StockKalkstein = _D41_StockKalkstein - (round (_playercount * 0.4));		if(_D41_StockKalkstein < 0)then {_D41_StockKalkstein = 0;};
	_D41_StockKrabben = _D41_StockKrabben - (round (_playercount * 0.4));				if(_D41_StockKrabben < 0)then {_D41_StockKrabben = 0;};
	_D41_StockDosenFisch = _D41_StockDosenFisch - (round (_playercount * 0.4));		if(_D41_StockDosenFisch < 0)then {_D41_StockDosenFisch = 0;};
	_D41_StockAlu = _D41_StockAlu - (round (_playercount * 0.5));					if(_D41_StockAlu < 0)then {_D41_StockAlu = 0;};
	...
	_query2 = "updateStock+2"
		...
		+ ":" + str(_D41_StockKrabben) + ":" + str(_D41_StockDosenFisch) + ":" + str(_D41_StockAlu) ;
	...
	//Items  ACHTUNG EK UND VK IST VERTAUSCHT!!
	
		//apple
		_Num = 0; _Type = _D41_StockApfel;				_VKPreis = (40/100);	_EKPreis = (5/100);		_mid = 17000;	[] call _D41_PreisAnpassung;		
		//peach
		_Num = 1; _Type = _D41_StockPfirsich;			_VKPreis = (50/100);	_EKPreis = (25/100);	_mid = 17000;	[] call _D41_PreisAnpassung;
		//Apfelschnaps
		_Num = 2;  _Type = _D41_StockApfelschnaps;		_VKPreis = (200/100);	_EKPreis = (165/100);	_mid = 5800;	[] call _D41_PreisAnpassung;
		//Pfirsichschnaps
		_Num = 3; _Type = _D41_StockPfirsichschnaps;	_VKPreis = (260/100);	_EKPreis = (210/100);	_mid = 5800;	[] call _D41_PreisAnpassung;
		//heroinp
		_Num = 4; _Type = _D41_StockheroinP;			_VKPreis = (1150/100);	_EKPreis = (1100/100);	_mid = 4500;	[] call _D41_PreisAnpassung;
		//oilp
		_Num = 5; _Type = _D41_Stockoilp;				_VKPreis = (1700/100);	_EKPreis = (1300/100);	_mid = 1100;		[] call _D41_PreisAnpassung;
		//marijuana
		_Num = 6; _Type = _D41_Stockmarijuana;			_VKPreis = (425/100);	_EKPreis = (350/100);	_mid = 5800;	[] call _D41_PreisAnpassung;
		//bjerky
		_Num = 7; _Type = _D41_Stockbjerky;				_VKPreis = (100/100);	_EKPreis = (25/100);	_mid = 17000;	[] call _D41_PreisAnpassung;
		//cocainep
		_Num = 8; _Type = _D41_Stockcocainep;			_VKPreis = (850/100);	_EKPreis = (800/100);	_mid = 2900;	[] call _D41_PreisAnpassung;
		//diamondc
		_Num = 9; _Type = _D41_Stockdiamondc;			_VKPreis = (2000/100);	_EKPreis = (1600/100);	_mid = 5800;		[] call _D41_PreisAnpassung;
		//iron_r
		_Num = 10; _Type = _D41_Stockiron_r;			_VKPreis = (900/100);	_EKPreis = (700/100);	_mid = 2500;		[] call _D41_PreisAnpassung;
		//copper_r
		_Num = 11; _Type = _D41_Stockcopper_r;			_VKPreis = (375/100);	_EKPreis = (300/100);	_mid = 2900;		[] call _D41_PreisAnpassung;
		//salt_r
		_Num = 12; _Type = _D41_Stocksalt_r;			_VKPreis = (115/100);	_EKPreis = (95/100);	_mid = 5800;	[] call _D41_PreisAnpassung;
		//coal
		_Num = 13; _Type = _D41_Stockcoal;				_VKPreis = (380/100);	_EKPreis = (300/100);	_mid = 4400;		[] call _D41_PreisAnpassung;
		//glass
		_Num = 14; _Type = _D41_Stockglass;				_VKPreis = (275/100);	_EKPreis = (225/100);	_mid = 11500;		[] call _D41_PreisAnpassung;
		//Apfelsaft
		_Num = 15; _Type = _D41_StockApfelsaft;			_VKPreis = (135/100);	_EKPreis = (110/100);	_mid = 17000;	[] call _D41_PreisAnpassung;
		//Pfirsichsaft
		_Num = 16; _Type = _D41_StockPfirsichsaft;		_VKPreis = (190/100);	_EKPreis = (150/100);	_mid = 17000;	[] call _D41_PreisAnpassung;
		//Ton
		_Num = 17; _Type = _D41_StockTon;				_VKPreis = (275/100);	_EKPreis = (225/100);	_mid = 4400;		[] call _D41_PreisAnpassung;
		//Zement
		_Num = 18; _Type = _D41_StockZement;			_VKPreis = (3450/100);	_EKPreis = (2500/100);	_mid = 2000;		[] call _D41_PreisAnpassung;
		//WKomp
		_Num = 19; _Type = _D41_StockWKomp;				_VKPreis = (1000/100);	_EKPreis = (750/100);	_mid = 250;		[] call _D41_PreisAnpassung;
		//Stahl
		_Num = 20; _Type = _D41_StockStahl;				_VKPreis = (19000/100);	_EKPreis = (14000/100);	_mid = 1750;		[] call _D41_PreisAnpassung;
		...
		//Kerosin
		_Num = 22; _Type = _D41_StockKerosin;			_VKPreis = (7900/100);	_EKPreis = (6000/100);	_mid = 1100;		[] call _D41_PreisAnpassung;
		//Kalkstein
		_Num = 23; _Type = _D41_StockKalkstein;			_VKPreis = (315/100);	_EKPreis = (250/100);	_mid = 4400;		[] call _D41_PreisAnpassung;
		//Krabben
		_Num = 24; _Type = _D41_StockKrabben;			_VKPreis = (2900/100);	_EKPreis = (1850/100);	_mid = 1800;	[] call _D41_PreisAnpassung;
		//Eingelegter Fisch
		_Num = 25; _Type = _D41_StockDosenFisch;		_VKPreis = (650/100);	_EKPreis = (550/100);	_mid = 8700;	[] call _D41_PreisAnpassung;
		//Aluminium
		_Num = 26; _Type = _D41_StockAlu;		_VKPreis = (900/100);	_EKPreis = (800/100);	_mid = 12000;	[] call _D41_PreisAnpassung;
