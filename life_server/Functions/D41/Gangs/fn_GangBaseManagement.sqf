	...
	//
		...
		if((_DBItemACount >= _DBItemACountBasis) && (_DBItemBCount >= _DBItemBCountBasis) && (_DBItemCCount >= _DBItemCCountBasis) && (_DBItemG >= _DBItemGBasis))then
		{
			...
			if(_Type == "Hero")then
			{
				...
				//HeroBase LowItem
				_MaxValue = 300000;
				_ItemArray = [["D41_BeefJerky",25,12000], ["D41_Apfelsaft",110,2727], ["D41_Pfirsichsaft",150,2000], ["D41_Apfelschnaps",165,1818], ["D41_Pfirsichschnaps",210,1428], ["D41_Salz",95,3157], ["D41_Ton",225,1333], ["D41_Glas",225,1333]];
				_RndmChosenItem = _ItemArray call BIS_fnc_selectRandom;
				[_RndmChosenItem, _MaxValue] call _selectIt;
				//HeroBase MidItem
				_MaxValue = 2000000;
				_ItemArray = [["D41_Kalkstein",250,8000], ["D41_Kohle",300,6666], ["D41_Eisen",700,2857], ["D41_Kupfer",300,6666], ["D41_Aluminium",800,2500], ["D41_Dosenfisch",450,4444], ["D41_WaffenKomponenten",900,2222]];
				_RndmChosenItem = _ItemArray call BIS_fnc_selectRandom;
				[_RndmChosenItem, _MaxValue] call _selectIt;
				//HeroBase HighItem
				_MaxValue = 3700000;
				_ItemArray = [["D41_Diamanten",1600,2312], ["D41_Krabben",1850,2000], ["D41_Zement",2500,1480], ["D41_Kerosin",6000,616], ["D41_Stahl",14000,264], ["D41_Fahrzeugteile",50000,74]];
				_RndmChosenItem = _ItemArray call BIS_fnc_selectRandom;
				[_RndmChosenItem, _MaxValue] call _selectIt;
			...
			if(_Type == "Neutral")then
			{
				...
				//NeutralBase LowItem
				_MaxValue = 175000;
				_ItemArray = [["D41_BeefJerky",25,7000], ["D41_Apfelsaft",110,1590], ["D41_Pfirsichsaft",150,1166], ["D41_Apfelschnaps",165,1060], ["D41_Pfirsichschnaps",210,833], ["D41_Salz",95,1842], ["D41_Dosenfisch",450,2000]];
				_RndmChosenItem = _ItemArray call BIS_fnc_selectRandom;
				[_RndmChosenItem, _MaxValue] call _selectIt;
				//NeutralBase MidItem
				_MaxValue = 900000;
				_ItemArray = [["D41_Kohle",300,3000], ["D41_Kupfer",300,3000], ["D41_Kalkstein",250,3600], ["D41_Ton",225,4000], ["D41_Glas",225,4000], ["D41_WaffenKomponenten",900,1000]];
				_RndmChosenItem = _ItemArray call BIS_fnc_selectRandom;
				[_RndmChosenItem, _MaxValue] call _selectIt;
				//NeutralBase HighItem
				_MaxValue = 1925000;
				_ItemArray = [["D41_Zement",2500,770], ["D41_Oel",1300,1480], ["D41_Cannabis",350,2500], ["D41_Fahrzeugteile",50000,38]];
				_RndmChosenItem = _ItemArray call BIS_fnc_selectRandom;
				[_RndmChosenItem, _MaxValue] call _selectIt;
			...
			{
				_BaseMoneyCost = 3499500;
				
				//BanditBase LowItem
				_MaxValue = 500;
				_ItemArray = [["D41_Apfelschnaps",165,2], ["D41_Pfirsichschnaps",210,2]];
				_RndmChosenItem = _ItemArray call BIS_fnc_selectRandom;
				[_RndmChosenItem, _MaxValue] call _selectIt;
				
				//BanditBase MidItem
				_MaxValue = 1200000;
				_ItemArray = [["D41_Cannabis",350,3428], ["D41_Kokain",800,1500], ["D41_WaffenKomponenten",900,1333]];
				_RndmChosenItem = _ItemArray call BIS_fnc_selectRandom;
				[_RndmChosenItem, _MaxValue] call _selectIt;
				
				//BanditBase HighItem
				_MaxValue = 1300000;
				_ItemArray = [["D41_Meth",19000,68], ["D41_GoldBarren",28000,46], ["D41_Heroin",1100,1181]];
				_RndmChosenItem = _ItemArray call BIS_fnc_selectRandom;
				[_RndmChosenItem, _MaxValue] call _selectIt;
