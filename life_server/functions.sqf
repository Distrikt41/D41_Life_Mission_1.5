...
";
//URD an alle
TON_fnc_cell_urdmsgall =
compileFinal "
	if(isServer) exitWith {};
	if((call life_mediclevel) < 1) exitWith {hint localize ""STR_NOTF_NotAMedic"";};
	private[""_msg"",""_from""];
	_msg = ctrlText 3003;
	if(_msg == """") exitWith {hint localize ""STR_D41_Need_Msg"";};
	
	[[_msg,name player,7,player],""TON_fnc_clientMessage"",true,false] call life_fnc_MP;
	[] call life_fnc_cellphone;
	hint format[localize ""STR_D41_MSG_URD_ALL"",_msg];
";
//Security an alle
TON_fnc_cell_secmsgall =
compileFinal "
	if(isServer) exitWith {};
	if(((call life_coplevel) < 1) && player getVariable [""D41_IsSec"", false]) exitWith {hint localize ""STR_NOTF_NotASec"";};
	private[""_msg"",""_from""];
	_msg = ctrlText 3003;
	if(_msg == """") exitWith {hint localize ""STR_D41_Need_Msg"";};
	
	[[_msg,name player,8,player],""TON_fnc_clientMessage"",true,false] call life_fnc_MP;
	[] call life_fnc_cellphone;
	hint format[localize ""STR_D41_MSG_SEC_ALL"",_msg];
";
...
publicVariable "TON_fnc_cell_urdmsgall";
publicVariable "TON_fnc_cell_secmsgall";
//Client Message
/*
	0 = private message
	1 = police message
...
compileFinal "
	...
	switch (_type) do
	{
		...
		case 5: {
			private[""_message""];
			_message = format[""!!!URD REQUEST: %1"",_msg];
			_Text = parseText format [""<t color='#FFCC00'><t size='2'><t align='center'>URD Request<br/><br/><t color='#33CC33'><t align='left'><t size='1'>To: <t color='#ffffff'>URD<br/><t color='#33CC33'>From: <t color='#ffffff'>%1<br/><br/><t color='#33CC33'>Message:<br/><t color='#ffffff'>%2"",_from,_msg];
			hint _Text;
			D41_LastMsg = _Text;
			
			[""TextMessage"",[format[""URD Request from %1"",_from]]] call bis_fnc_showNotification;
		};
		...
		case 6: {
			...
			_Text = parseText format [""<img size='10' color='#ffffff' image='textures\PolSymbol.paa'/><br/><t color='#316dff'><t size='2'><t align='center'>INFO CHANNEL<br/>Distrikt41 PD<br/><br/><t color='#33CC33'><t align='left'><t size='1'>To: <t color='#ffffff'>All Player<br/><t color='#33CC33'>From: <t color='#ffffff'>Public Police Info Channel<br/><br/><t color='#33CC33'>Message:<br/><t color='#ffffff'>%2"",_from,_msg];
			hint _Text;
			D41_LastMsg = _Text;
		...
		case 7: {
			private[""_message""];
			_from = localize ""STR_D41_MSG_URD_Channel"";
			_message = format[localize ""STR_D41_URD_Channel_MSG"",_msg];
			_Text = parseText format [""<img size='10' color='#ffffff' image='textures\URDSymbol.paa'/><br/><t color='#316dff'><t size='2'><t align='center'>INFO CHANNEL<br/>Distrikt41 URD<br/><br/><t color='#33CC33'><t align='left'><t size='1'>To: <t color='#ffffff'>All Player<br/><t color='#33CC33'>From: <t color='#ffffff'>Public URD Info Channel<br/><br/><t color='#33CC33'>Message:<br/><t color='#ffffff'>%2"",_from,_msg];
			hint _Text;
			D41_LastMsg = _Text;
			
			[""PoliceDispatch"",[format[localize ""STR_D41_MSG_URD_Channel""]]] call bis_fnc_showNotification;
			systemChat _message;
		};
		case 8: {
			private[""_message""];
			_from = localize ""STR_D41_SEC_URD_Channel"";
			_message = format[localize ""STR_D41_SEC_Channel_MSG"",_msg];
			_Text = parseText format [""<img size='10' color='#ffffff' image='textures\SecSymbol.paa'/><br/><t color='#316dff'><t size='2'><t align='center'>INFO CHANNEL<br/>Distrikt41 SECURITY<br/><br/><t color='#33CC33'><t align='left'><t size='1'>To: <t color='#ffffff'>All Player<br/><t color='#33CC33'>From: <t color='#ffffff'>Public SECURITY Info Channel<br/><br/><t color='#33CC33'>Message:<br/><t color='#ffffff'>%2"",_from,_msg];
			hint _Text;
			D41_LastMsg = _Text;
			
			[""PoliceDispatch"",[format[localize ""STR_D41_SEC_URD_Channel""]]] call bis_fnc_showNotification;
			systemChat _message;
		};
	};
";
